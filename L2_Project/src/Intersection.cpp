...
void WaitingVehicles::permitEntryToFirstInQueue()
{
    ...
    if (_vehicles.size() > 0)
    {
        _promises[0].set_value();           // Amr: This is how to set a void promise
...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    // Amr: Parent Thread is Intersection::addVehicleToQueue, Child (Worker) Thread is WaitingVehicles::permitEntryToFirstInQueue
